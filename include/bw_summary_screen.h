...
#define BW_SUMMARY_MON_IDLE_ANIMS_FRAMES            600     // number of frames between each idle anim IF BW_SUMMARY_MON_IDLE_ANIMS is true.
...
extern MainCallback gInitialSummaryScreenCallbackBW;
