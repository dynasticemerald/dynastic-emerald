...
#define WEATHER_LOCK_ABILITIES (ABILITY_CLOUD_NINE || ABILITY_AIR_LOCK)
...
#define ABILITY_GROUNDSHOCK         (ABILITIES_COUNT_GEN9 + 0)
#define ABILITY_STRIKER             (ABILITIES_COUNT_GEN9 + 1)
#define ABILITY_FATAL_PRECISION     (ABILITIES_COUNT_GEN9 + 2)
#define ABILITY_MOUNTAINEER         (ABILITIES_COUNT_GEN9 + 3)
#define ABILITY_MYSTIC_POWER        (ABILITIES_COUNT_GEN9 + 4)
#define ABILITY_SAND_SONG           (ABILITIES_COUNT_GEN9 + 5)
#define ABILITY_FLAMING_SOUL        (ABILITIES_COUNT_GEN9 + 6)
#define ABILITY_GHOSTAL_SOUL        (ABILITIES_COUNT_GEN9 + 7)
#define ABILITY_ARCHER              (ABILITIES_COUNT_GEN9 + 8)
#define ABILITY_HYPER_AGGRESIVE     (ABILITIES_COUNT_GEN9 + 9)
#define ABILITY_SWARMING_NEIGH      (ABILITIES_COUNT_GEN9 + 10) //Main Ability for Mega Flygon
#define ABILITY_FROSTY_BOOST        (ABILITIES_COUNT_GEN9 + 11)
#define ABILITY_GROUNDED_FLIGHT     (ABILITIES_COUNT_GEN9 + 12)
#define ABILITY_GHOST_FIST          (ABILITIES_COUNT_GEN9 + 13) //Iron Fist Copy for Ghost Types
#define ABILITY_TALONS_RESOLVE      (ABILITIES_COUNT_GEN9 + 14)
#define ABILITY_JETSTREAM           (ABILITIES_COUNT_GEN9 + 15)
#define ABILITY_SUPER_SLAMMER       (ABILITIES_COUNT_GEN9 + 16)
#define ABILITY_FOG_BANK            (ABILITIES_COUNT_GEN9 + 17) //Fog Weather
#define ABILITY_AROMATIC_MIST       (ABILITIES_COUNT_GEN9 + 18) //Shield Dust Copy
#define ABILITY_SPIKY_BARBS         (ABILITIES_COUNT_GEN9 + 19)

#define ABILITIES_COUNT_CUSTOM      (ABILITY_SPIKY_BARBS + 1)
