...
#define ITEM_FROST_ORB  (ITEM_POKESHI_DOLL + 3)
#define ITEM_SILVALLY_CATALOG (ITEM_POKESHI_DOLL + 4)

//Custom Mega Stones
//#define ITEM_BLASTOISINITE_D 829
#define ITEM_FLYGONITE (ITEM_POKESHI_DOLL + 5)
#define ITEM_TALONITE (ITEM_POKESHI_DOLL + 6)
