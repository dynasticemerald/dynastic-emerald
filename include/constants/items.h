...
#define ITEM_FRIENDSHIP_BOX (ITEM_STRANGE_BALL + 1)
#define ITEM_TIME_CHANGER (ITEM_STRANGE_BALL + 2)
#define ITEM_FROST_ORB  (ITEM_STRANGE_BALL + 3)
#define ITEM_SILVALLY_CATALOG (ITEM_STRANGE_BALL + 4)

//Custom Mega Stones
//#define ITEM_BLASTOISINITE_D 829
#define ITEM_FLYGONITE (ITEM_STRANGE_BALL + 5)
#define ITEM_TALONITE (ITEM_STRANGE_BALL + 6)

//Pokedex
#define INVISABLE_ITEM_POKEDEX (ITEM_STRANGE_BALL + 7)

//Badges
#define INVISABLE_ITEM_BADGE01 (ITEM_STRANGE_BALL + 8)

#define ITEMS_COUNT (INVISABLE_ITEM_BADGE01 + 1)
