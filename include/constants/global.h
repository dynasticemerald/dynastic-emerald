...
#define BAG_TMHM_COUNT 128 //Will be more aka need more space.
#define BAG_BERRIES_COUNT 46
#define BAG_BADGES_COUNT 8
...
#define ROAMER_COUNT 10 // Number of maximum concurrent active roamers
...
#define MINIMAL_GRINDING_MODE 0
#define DOUBLES_ONLY_MODE  1
