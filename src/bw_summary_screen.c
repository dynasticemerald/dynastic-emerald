...
enum BWPSSPage
{
    PSS_PAGE_INFO_BW,
    PSS_PAGE_SKILLS_BW,
    PSS_PAGE_BATTLE_MOVES_BW,
    PSS_PAGE_CONTEST_MOVES_BW,
    PSS_PAGE_COUNT_BW
};
...
static EWRAM_DATA struct PokemonSummaryScreenDataBW
{
    ...
    u16 bg2TilemapBuffers[PSS_PAGE_COUNT_BW][PSS_BUFFER_SIZE];
...
{
    [PSS_PAGE_INFO_BW] = PrintInfoPageText,
    [PSS_PAGE_SKILLS_BW] = PrintSkillsPageText,
    [PSS_PAGE_BATTLE_MOVES_BW] = PrintBattleMoves,
    [PSS_PAGE_CONTEST_MOVES_BW] = PrintContestMoves
};

static void (*const sTextPrinterTasks[])(u8 taskId) =
{
    [PSS_PAGE_INFO_BW] = Task_PrintInfoPage,
    [PSS_PAGE_SKILLS_BW] = Task_PrintSkillsPage,
    [PSS_PAGE_BATTLE_MOVES_BW] = Task_PrintBattleMoves,
    [PSS_PAGE_CONTEST_MOVES_BW] = Task_PrintContestMoves
};
...
void ShowPokemonSummaryScreen_BW(u8 mode, void *mons, u8 monIndex, u8 maxMonIndex, void (*callbackBW)(void))
{
    ...
    case BW_SUMMARY_MODE_BOX:
        ...
        sMonSummaryScreen->maxPageIndex = PSS_PAGE_COUNT_BW - 1;
        break;
    ...
    case BW_SUMMARY_MODE_SELECT_MOVE:
        sMonSummaryScreen->minPageIndex = PSS_PAGE_BATTLE_MOVES_BW;
        sMonSummaryScreen->maxPageIndex = PSS_PAGE_COUNT_BW - 1;
...
static void InitBGs(void)
{
    ...
    SetBgTilemapBuffer(2, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW]);
...
static bool8 DecompressGraphics(void)
{
    ...
    case 1:
        ...
        {
            LZDecompressWram(sSummaryPage_Info_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW]);
            sMonSummaryScreen->switchCounter++;
        }
        break;
    case 2:
        LZDecompressWram(sSummaryPage_Skills_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_SKILLS_BW]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 3:
        LZDecompressWram(sSummaryPage_BattleMoves_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES_BW]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 4:
        LZDecompressWram(sSummaryPage_ContestMoves_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_CONTEST_MOVES_BW]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 5:
...
static void SetSelectMoveTilemaps(void)
{
    SetBgTilemapBuffer(2, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES_BW]);
    SetBgTilemapBuffer(1, sMonSummaryScreen->bg1TilemapBuffers[PSS_EFFECT_BATTLE]);
...
static void HideInactivePageDots(void)
{
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES_BW][TILEMAP_PAGE_DOT_1_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES_BW][TILEMAP_PAGE_DOT_1_TILE_2] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES_BW][TILEMAP_PAGE_DOT_2_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES_BW][TILEMAP_PAGE_DOT_2_TILE_2] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_CONTEST_MOVES_BW][TILEMAP_PAGE_DOT_1_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_CONTEST_MOVES_BW][TILEMAP_PAGE_DOT_1_TILE_2] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_CONTEST_MOVES_BW][TILEMAP_PAGE_DOT_2_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_CONTEST_MOVES_BW][TILEMAP_PAGE_DOT_2_TILE_2] = TILE_BLACK_SQUARE;
}

static void LimitEggSummaryPageDisplay(void)
{
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_2_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_2_TILE_2] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_3_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_3_TILE_2] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_4_TILE_1] = TILE_BLACK_SQUARE;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_4_TILE_2] = TILE_BLACK_SQUARE;
    ScheduleBgCopyTilemapToVram(2);
}

static void RestoreSummaryPageDisplay(void)
{
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_2_TILE_1] = TILE_INACTIVE_SQUARE_TOP;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_2_TILE_2] = TILE_INACTIVE_SQUARE_BOTTOM;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_3_TILE_1] = TILE_INACTIVE_SQUARE_TOP;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_3_TILE_2] = TILE_INACTIVE_SQUARE_BOTTOM;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_4_TILE_1] = TILE_INACTIVE_SQUARE_TOP;
    sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO_BW][TILEMAP_PAGE_DOT_4_TILE_2] = TILE_INACTIVE_SQUARE_BOTTOM;
    ScheduleBgCopyTilemapToVram(2);
}
...
static void Task_ChangeSummaryMon(u8 taskId)
{
    ...
    case 11:
        ...
        break;
    case 12:
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_SKILLS_BW && BW_SUMMARY_IV_EV_DISPLAY == BW_IV_EV_GRADED)
...
static void PssScrollEnd(u8 taskId)
{
    if (sMonSummaryScreen->mode == BW_SUMMARY_MODE_SELECT_MOVE)
    {
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_CONTEST_MOVES_BW)
        {
...
static void DrawHPBar(struct Pokemon *unused)
{
    ...
    dst1 = &sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_SKILLS_BW][HP_BAR_TILEMAP_START_ROW_1];
    dst2 = &sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_SKILLS_BW][HP_BAR_TILEMAP_START_ROW_2];
    for (i = 0; i < 8; i++)
    {
        if (numHPBarTicks > 7)
        {
...
static void DrawExperienceProgressBar(struct Pokemon *unused)
{
    ...
    dst = &sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_SKILLS_BW][EXP_BAR_TILEMAP_START];
    for (i = 0; i < 8; i++)
    {
...
static void PutPageWindowTilemaps(u8 page)
{
    ...
    switch (page)
    {
    case PSS_PAGE_INFO_BW:
        PutWindowTilemap(PSS_LABEL_WINDOW_POKEMON_INFO_TITLE);
        PutWindowTilemap(PSS_LABEL_WINDOW_PROMPT_CANCEL);
        break;
    case PSS_PAGE_SKILLS_BW:
    ...
    case PSS_PAGE_BATTLE_MOVES_BW:
        ...
        break;
    case PSS_PAGE_CONTEST_MOVES_BW:
    ...
    for (i = 0; i < MAX_MON_MOVES; i++)
    {
        if (summary->moves[i] != MOVE_NONE)
        {
            if (P_SHOW_DYNAMIC_TYPES)
                monoType = CheckDynamicMoveType(mon, summary->moves[i], 0);
...
static void SetNewMoveTypeIcon(void)
{
    ...
    if (P_SHOW_DYNAMIC_TYPES)
        movetype = CheckDynamicMoveType(mon, sMonSummaryScreen->newMove, 0);
