...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .argument.twoTurnAttack = { .stringId = STRINGID_PKMNWHIPPEDWHIRLWIND, .status = B_WEATHER_FOG },
        .additionalEffects = ADDITIONAL_EFFECTS({
    ...
    [MOVE_EGG_BOMB] =
    {
        ...
        .description = COMPOUND_STRING(
            "An egg wich explodes into fire\n"
            "when it lands near the foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    //Buffed till here; taking a break.
    ...
    [MOVE_ROAR_OF_TIME] =
    {
        ...
        .description = COMPOUND_STRING(
            "A blast which distorts even time.\n"
    ...
    [MOVE_SPRINGTIDE_STORM] =
    {
        ...
        .effect = EFFECT_MISTY_ALWAYS_HIT,
    ...
    {
        .name = COMPOUND_STRING("Stellar Starstorm"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_SPIKES] =
    {
        .name = COMPOUND_STRING("Steel Spikes"),
        .description = COMPOUND_STRING(
            "Sets steel spikes that\n"
            "hurt a foe switching in."),
        .effect = EFFECT_STEEL_SPIKES,
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 0,
        .pp = 20,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_SteelSpikes,
    },
    ...
    [MOVE_TAKE_FLIGHT] =
    {
        ...
        .description = sUTurnDescription,
        .effect = EFFECT_HIT_ESCAPE_PHOTON_GEYSER_EFFECT,
        .power = 70,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 20,
