...
#define TYPHLOSION_EXP_YIELD 267
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FROSTY_BOOST, ABILITY_FLAMING_SOUL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_NONE, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_FRISK, ABILITY_KEEN_EYE },
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_FRISK, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_ARMOR_TAIL, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLACK,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_UNBURDEN, ABILITY_SOLID_ROCK },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_HUSTLE, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SUCTION_CUPS, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DARK_AURA, ABILITY_SOLAR_POWER, ABILITY_DARK_AURA },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_SAND_STREAM, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Tyranitar"),
