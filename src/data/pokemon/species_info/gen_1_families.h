...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARIZARD_MEGA_Y] =
    {
        ...
        FOOTPRINT(Charizard)
        OVERWORLD(
            sPicTable_Charizard, //Showing Normal charizard for now
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_FOOT,
            gOverworldPalette_Charizard, //Using the same pallete as normal charizard for now.
            gShinyOverworldPalette_Charizard //Using the same pallete as normal charizard for now.
        )
        .isMegaEvolution = TRUE,
        .levelUpLearnset = sCharizardLevelUpLearnset,
        .teachableLearnset = sCharizardTeachableLearnset,
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_SOLID_ROCK },
        .bodyColor = BODY_COLOR_BLUE,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .baseAttack    = 80 - 10,
        .baseDefense   = 75,
        .baseSpeed     = PIDGEOT_SPEED, // 101 speed
        .baseSpAttack  = 70 + 10,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_FLYING),
        .catchRate = 45,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_GALE_WINGS, ABILITY_TANGLED_FEET, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PIDGEOT_MEGA] =
    {
        ...
        .baseAttack    = 80 - 5,
        .baseDefense   = 80,
        .baseSpeed     = PIDGEOT_SPEED + 25, //126 Speed
        .baseSpAttack  = 135 + 5,
        .baseSpDefense = 80,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FOG_BANK, ABILITY_NO_GUARD, ABILITY_JETSTREAM },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pidgeot"),
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FRISK, ABILITY_KEEN_EYE, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .baseAttack    = 90 + 10,
        .baseDefense   = 55,
        .baseSpeed     = RAICHU_SPEED, //110 speed
        .baseSpAttack  = 90 + 10,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 75,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_GROUNDSHOCK },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_RAICHU_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SURGE_SURFER, ABILITY_NONE, ABILITY_GROUNDSHOCK },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Raichu"),
        .cryId = CRY_RAICHU,
        .natDexNum = NATIONAL_DEX_RAICHU,
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_SAND_RUSH },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_FRISK, ABILITY_COMPETITIVE, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_VENOMOTH}),
    },
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_TINTED_LENS, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_DIGLETT_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FILTER, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Diglett"),
        .cryId = CRY_DIGLETT,
        .natDexNum = NATIONAL_DEX_DIGLETT,
    ...
    [SPECIES_DUGTRIO_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FILTER, ABILITY_FILTER, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Dugtrio"),
        .cryId = CRY_DUGTRIO,
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TECHNICIAN, ABILITY_PICKUP, ABILITY_UNNERVE },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_PERSIAN}),
    },
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_MYSTIC_POWER, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MEOWTH_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MYSTIC_POWER, ABILITY_TECHNICIAN, ABILITY_RATTLED },
    ...
    [SPECIES_PERSIAN_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_MYSTIC_POWER, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Persian"),
        .cryId = CRY_PERSIAN,
        .natDexNum = NATIONAL_DEX_PERSIAN,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_PRIMEAPE}),
    },
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_RAIN_DISH, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_RAPIDASH_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_PASTEL_VEIL, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Rapidash"),
        .cryId = CRY_RAPIDASH,
        .natDexNum = NATIONAL_DEX_RAPIDASH,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    {
        .baseHP        = 52 + 30,
        .baseAttack    = FARFETCHD_ATTACK + 11,
        .baseDefense   = 55 + 20,
        .baseSpeed     = 60 + 25,
        .baseSpAttack  = 58 - 43,
        .baseSpDefense = 62 + 20,
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .formSpeciesIdTable = sFarfetchdFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_SIRFETCHD}),
    },
    ...
    [SPECIES_DODUO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_DODRIO}),
    },
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_EARLY_BIRD, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_BROWN,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_STURDY, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_SAND_FORCE, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Steelix"),
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_FOREWARN, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Hypno"),
        .cryId = CRY_HYPNO,
...
#if P_MEGA_EVOLUTIONS
    [SPECIES_KINGLER_GIGANTAMAX] = //New Mega
    {
        .baseHP        = 55,
        .baseAttack    = 155,
        .baseDefense   = 140,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_WEEZING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_8
        .abilities = { ABILITY_CLOUD_NINE, ABILITY_NEUTRALIZING_GAS, ABILITY_TOXIC_DEBRIS },
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_LIGHTNING_ROD, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_NATURAL_CURE, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ELECTIVIRE] =
    {
        ...
        .baseSpAttack  = 95 - 5,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FIGHTING), //Was MON_TYPES(TYPE_ELECTRIC)
        .catchRate = 30,
        .expYield = 270,
        .evYield_Attack = 3,
        .itemRare = ITEM_ELECTIRIZER,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_IRON_FIST, ABILITY_MOTOR_DRIVE, ABILITY_GROUNDSHOCK }, //Was { ABILITY_MOTOR_DRIVE, ABILITY_NONE, ABILITY_VITAL_SPIRIT }
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TRACE, ABILITY_DOWNLOAD, ABILITY_FATAL_PRECISION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_DOWNLOAD, ABILITY_FATAL_PRECISION },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_GLUTTONY, ABILITY_THICK_FAT, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_AROMATIC_MIST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ARTICUNO_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COMPETITIVE, ABILITY_NONE, ABILITY_AROMATIC_MIST },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Articuno"),
        .cryId = CRY_ARTICUNO,
        .natDexNum = NATIONAL_DEX_ARTICUNO,
