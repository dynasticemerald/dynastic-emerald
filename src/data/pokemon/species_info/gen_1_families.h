...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIDGEOT_MEGA] =
    {
        ...
        .baseAttack    = 80 - 5,
        .baseDefense   = 80,
        .baseSpeed     = PIDGEOT_SPEED + 30, //131 Speed
        .baseSpAttack  = 135 + 5,
        .baseSpDefense = 80,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_ELECTIVIRE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_GROUNDSHOCK }, //Was { ABILITY_MOTOR_DRIVE, ABILITY_NONE, ABILITY_VITAL_SPIRIT }
        .bodyColor = BODY_COLOR_YELLOW,
