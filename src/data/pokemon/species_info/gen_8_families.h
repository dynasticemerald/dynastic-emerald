...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_ELDEGOSS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_COTTON_DOWN, ABILITY_REGENERATOR, ABILITY_SEED_SOWER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DREDNAW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SHELL_ARMOR, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    {
        .baseHP        = 75,
        .baseAttack    = 114, //Was 98, Too Lazy to do the math.
        .baseDefense   = 70,
        .baseSpeed     = 75,
        .baseSpAttack  = 98, //Was 114, Too Lazy to do the math.
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_POISON),
        .catchRate = 45,
        .expYield = 176,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TOXIC_CHAIN, ABILITY_MINUS, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Toxtricity"),
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_COPPERAJAH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_HEAVY_METAL, ABILITY_SUPER_SLAMMER },
        .bodyColor = BODY_COLOR_GREEN,
