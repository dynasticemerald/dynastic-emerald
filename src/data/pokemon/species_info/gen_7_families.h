...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 34, SPECIES_DECIDUEYE},
                                {EVO_LEVEL_DAY, 34, SPECIES_DECIDUEYE_HISUI}),
    },
    ...
    [SPECIES_DECIDUEYE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_ARCHER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SUPER_SLAMMER, ABILITY_IRON_FIST, ABILITY_ANGER_POINT },
    ...
    [SPECIES_TOXAPEX] =
    {
        ...
        .abilities = { ABILITY_MERCILESS, ABILITY_TOXIC_DEBRIS, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_BLUE,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_ZERAORA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_NONE, ABILITY_SUPER_SLAMMER },
        .bodyColor = BODY_COLOR_YELLOW,
