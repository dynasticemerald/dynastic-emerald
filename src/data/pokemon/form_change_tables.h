...
static const struct FormChange sVenusaurFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_GIGANTAMAX,             SPECIES_VENUSAUR_MEGA_D},
#endif
...
#endif
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX,             SPECIES_CHARIZARD_MEGA_D},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBlastoiseFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_BLASTOISE_MEGA_D, ITEM_BLASTOISINITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sWishiwashiFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT,  SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN, 20},
    {FORM_CHANGE_BATTLE_HP_PERCENT,  SPECIES_WISHIWASHI_SOLO, ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 20},
...
static const struct FormChange sSilvallyFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_NORMAL,   ITEM_SILVALLY_CATALOG,   0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_FIGHTING, ITEM_SILVALLY_CATALOG,   1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_FLYING,   ITEM_SILVALLY_CATALOG,   2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_POISON,   ITEM_SILVALLY_CATALOG,   3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_GROUND,   ITEM_SILVALLY_CATALOG,   4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_ROCK,     ITEM_SILVALLY_CATALOG,   5},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_BUG,      ITEM_SILVALLY_CATALOG,   6},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_GHOST,    ITEM_SILVALLY_CATALOG,   7},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_STEEL,    ITEM_SILVALLY_CATALOG,   8},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_FIRE,     ITEM_SILVALLY_CATALOG,   9},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_WATER,    ITEM_SILVALLY_CATALOG,  10},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_GRASS,    ITEM_SILVALLY_CATALOG,  11},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_ELECTRIC, ITEM_SILVALLY_CATALOG,  12},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_PSYCHIC,  ITEM_SILVALLY_CATALOG,  13},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_ICE,      ITEM_SILVALLY_CATALOG,  14},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_DRAGON,   ITEM_SILVALLY_CATALOG,  15},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_DARK,     ITEM_SILVALLY_CATALOG,  16},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_SILVALLY_FAIRY,    ITEM_SILVALLY_CATALOG,  17},
    {FORM_CHANGE_TERMINATOR},
};
