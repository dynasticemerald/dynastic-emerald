...
// Memories
    ...
    [ITEM_RUSTED_SWORD] =
    {
        .name = _("Rusted Sword"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_RUSTED_SS,
        .description = COMPOUND_STRING(
            "A rusty sword. A\n"
            "hero used it to\n"
            "halt a disaster."),
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_FALSE_SWIPE] =
    {
        .name = _("TM01"),
        .price = 1250,
        .description = sFalseSwipeDescription, // Im lazy
    ...
    [ITEM_TM_THUNDER_FANG] = //Thunder Fang
    {
        .name = _("TM59"),
        .price = 3000,
        .description = COMPOUND_STRING(
    ...
    [ITEM_TM_DUAL_CHOP] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DUAL_CHOP, // Todo
    },
...
// GEN 9 ITEMS
    ...
    [ITEM_LEADERS_CREST] =
    {
        ...
        .price = 3000,
        .holdEffect = HOLD_EFFECT_LEADERS_CREST, // Boosts the Pawniard's Line dark and steel type moves by 1.2x.
        .description = COMPOUND_STRING(
            "Boosts the Pawnia-\n"
            "rd's Line STAB\n"
            "moves. 1.3x Boost."),
    ...
    [ITEM_FRIENDSHIP_BOX] =
    {
        .name = _("Friendship Box"),
        .pluralName = _("Friend Boxs"),
        .price = 0,
        .holdEffectParam = 10,
        .description = COMPOUND_STRING(
            "Makes a Pokémon\n"
