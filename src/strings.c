...
const u8 gText_TextSpeedSlow[] = _("{SHADOW LIGHT_GREEN}Slo");
const u8 gText_TextSpeedMid[] = _("{SHADOW LIGHT_GREEN}Mid");
const u8 gText_TextSpeedFast[] = _("{SHADOW LIGHT_GREEN}Fast");
const u8 gText_TextSpeedInstant[] = _("{SHADOW LIGHT_GREEN}Inst");
const u8 gText_BattleSceneOn[] = _("{SHADOW LIGHT_GREEN}On");
const u8 gText_BattleSceneOff[] = _("{SHADOW LIGHT_GREEN}Off");
const u8 gText_BattleStyleShift[] = _("{SHADOW LIGHT_GREEN}Shift");
const u8 gText_BattleStyleSet[] = _("{SHADOW LIGHT_GREEN}Set");
const u8 gText_SoundMono[] = _("{SHADOW LIGHT_GREEN}Mono");
const u8 gText_SoundStereo[] = _("{SHADOW LIGHT_GREEN}Stereo");
const u8 gText_FrameType[] = _("{SHADOW LIGHT_GREEN}Type");
const u8 gText_FrameTypeNumber[] = _("{SHADOW LIGHT_GREEN}");
const u8 gText_ButtonTypeNormal[] = _("{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_ButtonTypeLR[] = _("{SHADOW LIGHT_GREEN}LR");
const u8 gText_ButtonTypeLEqualsA[] = _("{SHADOW LIGHT_GREEN}L=A");
