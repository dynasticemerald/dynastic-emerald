...
} static const sMainMenuTexts[OPTIONS_COUNT] =
{
    ...
    [OPTION_DEPOSIT]    = {COMPOUND_STRING("Deposite Pokémon"),  COMPOUND_STRING("Store Pokémon in your party in Boxes.")},
    [OPTION_MOVE_MONS]  = {COMPOUND_STRING("Move Pokemon"),     COMPOUND_STRING("Organize the Pokémon in Boxes and\nin your party.")},
